...
from event_model import compose_resource # type: ignore
from ophyd_async.core import Device, SignalR, SignalRW, StandardReadableFormat
...
class Detector(Device):
    sum = Annotated[SignalRW, StandardReadableFormat.HINTED]
    max = Annotated[SignalRW, StandardReadableFormat.NORMAL]
    area = Annotated[SignalRW, StandardReadableFormat.NORMAL]
    cen_x = Annotated[SignalRW, StandardReadableFormat.HINTED]
    cen_y = Annotated[SignalRW, StandardReadableFormat.HINTED]
    wid_x = Annotated[SignalRW, StandardReadableFormat.HINTED]
    wid_y = Annotated[SignalRW, StandardReadableFormat.HINTED]
    image = Annotated[ExternalFileReference, StandardReadableFormat.NORMAL]
